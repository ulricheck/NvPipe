...
class NvPipeConan(ConanFile):
    ...
    exports = ["CMakeLists.txt", "FindNvPipe.cmake", "src", "examples"]
    ...
    requires = (
        ...
        "nvidia-video-codec-sdk/9.0.20@vendor/stable",  # private repository due to license terms - just provides includes and libs
        )
